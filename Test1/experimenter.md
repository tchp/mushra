...
Shows the participant's ratings of a mushra page and gives the possibility to play back each condition. 

* **type** must be mushra_results.
* **id** Identifier of the page.
* **name** Name of the page (is shown as title)
* **content** Content (HTML) of the page.
* **mushra_page_id** Id of a previous shown mushra page.
...
A likert single stimulus page creates a multi-stimulus likert rating.
...
A spatial page allows to carry out listening tests about spatial attributes. We are currently reimplementing spatial pages to provide a better core quality. Therefore, the spatial page is not working.
