...
function PageTemplateRenderer(_pageManager, _showButtonPreviousPage) {
...
PageTemplateRenderer.prototype.renderNavigation = function(_parentId) {
  ...
  if (this.pageManager.getPageIndex() > 0 && this.showButtonPreviousPage && this.pageManager.getPageIndex() < (this.pageManager.getNumPages() - 1)) {
    var buttonPrevious = $("<button data-role='button' data-inline='true' onclick='" + this.pageManager.getPageManagerVariableName() + ".previousPage();'>Previous</button>");
  ...
  if (this.pageManager.getPageIndex() < (this.pageManager.getNumPages() - 1)) {
    var buttonNext = $("<button id='__button_next' data-role='button' data-inline='true' onclick='" + this.pageManager.getPageManagerVariableName() + ".nextPage();'>Next</button>");
