...
function FinishPage(_pageManager, _session, _dataSender, _pageConfig) {
...
FinishPage.prototype.render = function (_parent) {
    ...
    var button = $("<button id='send_results' data-role='button' data-inline='true' disabled='disabled'>Send Results</button>");
    ...
    this.interval = setInterval((function(){ 
      ...
      for (i = 0; i < this.pageConfig.questionnaire.length; ++i) {
        ...
        if (element.type === "text") {
          ...
          if (this.likert && $("input[name='" + element.name + "__response']:checked").val()) {
            ++counter;
          }  
