...
Scene.prototype.transformRelativeCoordinates = function(_relX, _relY, _activeObjX, _activeObjY, _activeObjZ) {
  ...
  if(this.wmCamera.type == 1){ //orthographic camera
  	...
  	quaternion.setFromUnitVectors( new THREE.Vector3(0,0,-1), cameraDir_n); 
  	var quaternion_y = new THREE.Quaternion(); 
  	var orthoProj = new THREE.Vector3(cameraDir_n.x, 0, cameraDir_n.z);
  	quaternion_y.setFromUnitVectors(new THREE.Vector3(0,0,-1), orthoProj.normalize());
